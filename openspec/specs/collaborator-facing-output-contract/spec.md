# collaborator-facing-output-contract Specification

## Purpose
Define the collaborator-facing replicate-aware output contract: primary workbook, artifact roles, plot/workbook inspection expectations, selected-analyte summary behavior, and maintainable helper organization.
